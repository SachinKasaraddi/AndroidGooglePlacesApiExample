...
public class GooglePlacesExample extends ListActivity {
	...
	final String GOOGLE_KEY = "AIzaSyBEDz6KAfo-bUJlmmIR2ubkYquUIUqLh5M";
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        String lat = String.valueOf(extras.getDouble("latitude"));
	...
	private class googleplaces extends AsyncTask<View, Void, String> {
       ...
       Bundle extras = getIntent().getExtras();
        ...
        final String latitude = String.valueOf(extras.getDouble("latitude"));
        final String longtitude = String.valueOf(extras.getDouble("longitude"));

        @Override
		protected String doInBackground(View... urls) {
			// make Call to the url
			temp = makeCall("https://maps.googleapis.com/maps/api/place/search/json?location=" + latitude + "," + longtitude + "&radius=500&types=bus_station&sensor=true&key=" + GOOGLE_KEY);
			
			//print the call in the console
			System.out.println("https://maps.googleapis.com/maps/api/place/search/json?location=" + latitude + "," + longtitude + "&radius=100&types=bus_station|post_office&sensor=true&key=" + GOOGLE_KEY);
			return "";
		}
